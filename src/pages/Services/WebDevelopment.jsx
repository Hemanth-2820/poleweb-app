...
const WebDevelopment = () => {
  ...
  return (
    <div className="service-page webdevelopment-page">
      {/* 1. HERO SECTION */}
              ...
              <div className="glass-card visual-card">
                <div className="visual-code-mockup">
                  ...
                  <div className="mockup-body">
                    <code>
                      <span className="code-keyword">const</span> <span className="code-var">service</span> = <span className="code-keyword">new</span> <span className="code-class">WebDevelopment</span>();<br/>
      ...
      <section className="service-offers section">
        <div className="container">
          ...
          <motion.div 
            ...
            variants={staggerContainer}
          >
            {["Business Websites","Company Websites","Portfolio Websites","Landing Pages","E-Commerce Websites","Custom Web Applications","Admin Dashboards","SaaS Platforms","Responsive Website Design","Website Redesign"].map((offer, index) => (
