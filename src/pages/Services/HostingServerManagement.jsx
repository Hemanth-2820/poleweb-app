...
const HostingServerManagement = () => {
  ...
  return (
    <div className="service-page hostingservermanagement-page">
      {/* 1. HERO SECTION */}
            ...
            >
              <div className="glass-card visual-card">
                <div className="visual-code-mockup">
                  ...
                  <div className="mockup-body">
                    <code>
                      <span className="code-keyword">const</span> <span className="code-var">service</span> = <span className="code-keyword">new</span> <span className="code-class">HostingServerManagement</span>();<br/>
...
export default HostingServerManagement;
